    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProfessorStatuses", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfessorStatusId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Professors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Professors_DocumentTypes_DocumentTypeId",
                        column: x => x.DocumentTypeId,
                        principalTable: "DocumentTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Professors_ProfessorStatuses_ProfessorStatusId",
                        column: x => x.ProfessorStatusId,
                        principalTable: "ProfessorStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Professors_Specialities_SpecialityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Students_DocumentTypes_DocumentTypeId",
                        column: x => x.DocumentTypeId,
                        principalTable: "DocumentTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PreRequirements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PreRequirements_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PreRequirements_Courses_RequiredCourseId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    EnrollmentNumber = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PreRequirements_CourseId",
                table: "PreRequirements",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_PreRequirements_RequiredCourseId",
                table: "PreRequirements",
                column: "RequiredCourseId");

            migrationBuilder.CreateIndex(
                name: "IX_Professors_DocumentNumber",
                table: "Professors",
                column: "DocumentNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Professors_DocumentTypeId",
                table: "Professors",
                column: "DocumentTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_Professors_ProfessorStatusId",
                table: "Professors",
                column: "ProfessorStatusId");

            migrationBuilder.CreateIndex(
                name: "IX_Professors_SpecialityId",
                table: "Professors",
                column: "SpecialityId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Students_DocumentTypeId",
                table: "Students",
                column: "DocumentTypeId");
